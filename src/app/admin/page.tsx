...
const sectionGroups = [
  {
    groupLabel: 'PUBLICIDAD',
    groupIcon: 'campaign',
    sections: [
      { href: '/admin/publicidad/hero', label: 'Hero', icon: 'panorama', desc: 'Título, subtítulo, imagen de fondo y botones de acción.' },
      { href: '/admin/publicidad/bento', label: 'Bento Grid', icon: 'grid_view', desc: 'Añade, edita o elimina tarjetas del grid visual.' },
    ],
  },
  {
    groupLabel: 'TIENDA',
    ...
    sections: [
      ...
      { href: '/admin/categories', label: 'Categorías', icon: 'account_tree', desc: 'Marcas, colecciones y modelos.' },
    ...
    <div className="p-10 max-w-4xl">
      ...
      {data && (
        <div className="grid grid-cols-3 gap-4 mb-12">
          ...
          <div className="bg-[#111] border border-white/8 p-6">
            <p className="font-label-caps text-[9px] tracking-[0.15em] text-white/30 mb-2">TARJETAS BENTO</p>
            <p className="text-white text-3xl font-light tabular-nums">{(data.bentoItems ?? []).length}</p>
          </div>
          <div className="bg-[#111] border border-white/8 p-6">
